...
Tests:
1. loomscan metamorphic --file with relative path (was crashing)
2. loomscan strictness --level N with __strictness__ in YAML (was crashing)
...
# =============================================================================
# 1. loomscan metamorphic --file relative path fix
# =============================================================================

class TestMetamorphicRelativePath:
    """v4.43: loomscan metamorphic --file <relative_path> was crashing.
    The path wasn't resolved against repo_root."""

    def test_metamorphic_relative_path_no_crash(self, tmp_path):
        """End-to-end: loomscan metamorphic --file with a relative path should
...
# =============================================================================
# 2. loomscan strictness --level N with __strictness__ fix
# =============================================================================

class TestStrictnessLevelFix:
    """v4.43: loomscan strictness --level N crashed when .loomscan.yaml contained
...
class TestStaleTodoRemoved:
    ...
    def test_no_stale_todo_in_project_tuner(self):
        content = (PROJECT_ROOT / "loomscan" / "brain" / "project_tuner.py").read_text()
...
class TestVersionV443:
    def test_version_is_4_43(self):
        ...
        assert major >= 4, f"Expected >= 4.43.0, got {__version__}"
