...
/**
 * Settings UI: Settings > Tools > LoomScan.
 *
 * Mirrors the VS Code extension's configuration panel.
 */
class LoomScanSettingsConfigurable : Configurable {

    private val enabledCheckbox = JBCheckBox("Enable LoomScan real-time diagnostics")
