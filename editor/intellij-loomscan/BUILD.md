# Building the LoomScan JetBrains Plugin
...
4. Select `build/distributions/loomscan-intellij-0.1.0.zip`
5. Restart IntelliJ

## CI build

The plugin is automatically built by GitHub Actions on every push to `editor/intellij-loomscan/`.
...
3. Upload `build/distributions/loomscan-intellij-0.1.0.zip`
