...
/**
 * LSP server support for STCA.
 *
 * This connects IntelliJ's built-in LSP support (IntelliJ 2023.1+) to the
 * `stca lsp` server. IntelliJ handles the LSP protocol, file watching, and
...
class StcaLspServerSupport : LspServerSupportProvider() {
    ...
    override fun createServerDescriptor(project: Project, ideaLspServerManager: ProjectLspServerManager): LspServerDescriptor? {
        val settings = com.stca.pipeline.settings.StcaSettingsService.getInstance()
        ...
        return object : LspServerDescriptor(project, "STCA") {
            ...
            override fun createCommandLine(): com.intellij.execution.configurations.GeneralCommandLine {
                return com.intellij.execution.configurations.GeneralCommandLine(
                    pythonPath,
                    "-c",
                    "from stca.cli import main; main()",
                    "lsp",
                    "--repo",
                    projectRoot
            ...
            override fun isSupportedFile(file: VirtualFile): Boolean {
                return isStcaSupportedFile(file)
            }
        }
    }
    ...
    companion object {
        ...
        fun isStcaSupportedFile(file: VirtualFile): Boolean {
