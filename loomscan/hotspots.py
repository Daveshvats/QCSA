...
The flow:
  1. LoomScan detects a potential issue, marks it as a Hotspot (not a Vulnerability)
...
HOTSPOTS_FILE = ".loomscan-hotspots.json"
...
class HotspotManager:
    ...
    def __init__(self, repo_root: Path):
        ...
        self.hotspot_audit_file = repo_root / ".loomscan-hotspot-audit.log"
        self._load()
