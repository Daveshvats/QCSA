"""Configuration loader for `.loomscan.yaml`.
...
DEFAULT_CONFIG_NAME = ".loomscan.yaml"
...
class STCAConfig:
    ...
    # When set, LoomScan scans each workspace as a separate logical project,
    ...
    # feedback stats file
    stats_file: str = ".loomscan-stats.json"

    # report directory
    report_dir: str = ".loomscan-reports"
    ...
    def from_dict(cls, raw: Dict) -> "STCAConfig":
        ...
        # users in .loomscan.yaml are silently ignored. The entire v4.10-v4.13
...
def find_config(repo_root: Optional[Path] = None) -> Path:
    """Walk up from repo_root (or cwd) to find .loomscan.yaml."""
