...
def generate_dashboard(repo_root: Path, out_path: Path,
    ...
    title = title or f"LoomScan Dashboard — {repo_root.name}"
...
<body>
  ...
  <p class="small" style="margin-top: 2em;">Generated by LoomScan — deterministic-first, type-2 fuzzy aggregated.</p>
