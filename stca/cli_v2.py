"""v2 CLI commands — registers additional `stca <cmd>` subcommands.
...
@click.option("--rules-dir", default=".stca/rules", help="Directory of custom rule files")
...
def optimize_cmd(repo: str, clear_cache: bool):
    ...
    from . import incremental
    repo_root = Path(repo).resolve()
    cache_dir = repo_root / ".stca-cache"
