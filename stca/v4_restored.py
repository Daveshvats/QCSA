...
All implementation code has been moved to:
  - stca/expanded_rules.py — scan_expanded_js/java/repo, JS_EXPANDED_RULES, JAVA_EXPANDED_RULES
  - stca/codebase_understanding.py — index_codebase, analyze_codebase, CodebaseModel
  - stca/semantic_bl.py — detect_semantic_bl, detect_semantic_repo
  - stca/multi_lang_null.py — detect_null_dereference_multi, detect_null_repo
  - stca/multi_lang_testing.py — generate_js/go/java/rust/cpp tests
  - stca/multi_lang_typestate.py — detect_state_machine_multi, detect_typestate_multi, detect_spec_mining, detect_metamorphic
  - stca/multi_lang_taint.py — detect_cpg_taint_multi, _cpg_taint_py_fallback
  - stca/multi_lang_contracts.py — detect_contracts_multi, auto_fix_multi
"""
