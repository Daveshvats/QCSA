...
OBSERVATIONS_FILE = os.environ.get('STCA_OBSERVATIONS_FILE', '/tmp/stca_observations.json')
observations = []
...
""").strip())
    ...
    test_file = (repo_root or file_path.parent) / ".stca-cache" / "dynamic_invariants" / f"test_{file_path.stem}_dyninv.py"
